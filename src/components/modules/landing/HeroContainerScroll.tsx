...
export const HeroContainerScroll: React.FC<HeroContainerScrollProps> = ({}) => {
  ...
  return (
    <div
      className="flex items-center justify-center relative pt-36 z-[2]"
      ref={containerRef}
    >
      <div
      ...
      >
        ...
        >
          ...
          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
            <h1 className="text-7xl font-bold text-center md:text-[300px] z-[99999]">
              Webrly
            </h1>
          </div>
        </motion.div>
