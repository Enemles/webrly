...
import { getAuthUserDetails, getUserPermissions,changeUserPermissions, updateUser } from '@/lib/services/auth';
...
const UserDetails = ({ id, type, userData, subAccounts }: Props) => {
  ...
  const [authUserData, setauthUserData] = useState<AuthUserWithAgencySigebarOptionsSubAccounts | null>();
