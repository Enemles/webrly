      ...
      <SheetContent showX={!defaultOpen} side={'left'} className={clsx('bg-background/80 backdrop-blur-xl fixed top-0 border-r-[1px] p-6', { "hidden md:inline-block z-0 w-[300px]": defaultOpen, 'inline-block md:hidden z-[100] w-full': !defaultOpen })}>
        <div>
          <AspectRatio ratio={16 / 5}>
            <Image src={sidebarLogo} alt="logo" fill className="rounded-md object-contain" />
          </AspectRatio>
          <Popover>
                  ...
                  user?.role === 'AGENCY_ADMIN') && (
                    <SheetClose>
                      ...
                      <Button className="w-full flex gap-2" onClick={() => {
                        setOpen(
                          <CustomModal title="Create SubAccount" subHeading="You can switch between your agency account and the subaccount from the sidebar">
                            <SubAccountDetails
